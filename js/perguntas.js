export const perguntas = [
    {
        enunciado: "Você está andandando em uma rua escura, derrepente bate em algo, você observa o que é e...?",
        alternativas: [
            {
                texto: "Dar meia volta!",
                afirmacao: [
                    "Você dá meia volta e procura abrigo da luz,",
                    "Sentiu medo do que podia estar esperando naquela escuridão."
                ],
                proxima: 1,
            },
            {
                texto: "Investigar o qu é!",
                afirmacao: [
                    "Decidiu dar uma olhada no que era aquilo que trombou.",
                    "Descobriu um carro desligado, achave deve estar por perto."
                ],
                proxima: 2,
            },
        ]
